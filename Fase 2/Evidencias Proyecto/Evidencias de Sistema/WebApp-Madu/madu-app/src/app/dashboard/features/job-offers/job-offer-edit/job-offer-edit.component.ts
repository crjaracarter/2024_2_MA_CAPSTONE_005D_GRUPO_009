      ...
      <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        >
          ...
          <div>
            ...
            />
            <p
              *ngIf="jobOfferForm.get('title')?.errors?.['required'] && jobOfferForm.get('title')?.touched"
          ...
          <div>
            ...
            <p
              *ngIf="jobOfferForm.get('description')?.errors?.['required'] && jobOfferForm.get('description')?.touched"
              class="mt-1 text-sm text-red-600"
            >
          ...
          <div>
            ...
            />
            <p
              *ngIf="jobOfferForm.get('location')?.errors?.['required'] && jobOfferForm.get('location')?.touched"
              class="mt-1 text-sm text-red-600"
            >
...
export class JobOfferEditComponent implements OnInit {
  ...
  async ngOnInit() {
    // Esperar a que obtengamos los datos del usuario antes de continuar
    ...
    if (!user || user.rol !== UserRole.EMPLEADOR) {
      console.log('Usuario no autorizado o no es empleador'); // Debug
  ...
  private async loadJobOffer() {
    ...
    console.log('ID de la oferta a editar:', id);
    ...
    console.log('Oferta obtenida:', jobOffer);
    ...
    if (jobOffer.employerId !== this.currentUserId) {
      console.log('Usuario no autorizado para editar esta oferta:', {
    ...
    console.log('Formulario inicializado:', this.jobOfferForm?.value);
  }
    ...
    if (this.jobOfferForm?.valid) {
      ...
      try {
        if (id) {
          ...
          console.log('Navegando a los detalles de la oferta laboral');
          this.router.navigate(['/dashboard/job-offers/detail', id]);
        }
      } catch (error) {
