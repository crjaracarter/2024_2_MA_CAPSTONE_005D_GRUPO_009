  ...
  template: `
    <div class="p-4">
      <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-white" >Ofertas Laborales</h2>
        <button
          *ngIf="isEmployer"
...
export class JobOfferListComponent implements OnInit {
  ...
  viewDetails(offerId: string) {
    this.router.navigate(['/dashboard/job-offers/detail/', offerId]);
  }
  navigateToCreate() {
    this.router.navigate(['/dashboard/job-offers/create']);
  }
}
